...
/**
 * The process trace for each step of the agent execution, which can be used for better understanding the process of the
 * agent, and can be included in the prompt for better explainability. The trace should be concise and informative, and
 * can be generated by the agent based on the context and the action description.
 * */
