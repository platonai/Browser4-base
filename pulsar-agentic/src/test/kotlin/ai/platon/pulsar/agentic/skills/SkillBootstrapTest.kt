...
class SkillBootstrapTest {
    ...
    @Test
    fun `test bootstrap initializes example skills`() {
    ...
    @Test
    fun `test bootstrap loads skills in correct order`() {
        bootstrap.initialize()
    ...
    @Test
    fun `test bootstrap can be called multiple times`() {
    ...
    @Test
    fun `test bootstrap loads all example skills successfully`() {
        bootstrap.initialize()
    ...
    @Test
    fun `test example skills have correct metadata`() {
        bootstrap.initialize()
